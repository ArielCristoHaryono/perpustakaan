            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $sql2 = "SELECT * FROM katalog, pinjam WHERE katalog.id = pinjam.bookid";
                            // "SELECT katalog.id, katalog.judul, katalog.penulis,  pinjam.namapinjam, pinjam.tglpinjam, pinjam.tglkembali
