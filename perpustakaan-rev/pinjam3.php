...
if (isset($_POST['simpan'])) { // untuk create
    ...
    if ($namapinjam && $tglpinjam && $tglkembali) {
        ...
        if ($op == 'edit') { //untuk update
            $sql1 = "INSERT INTO pinjam (bookid, namapinjam, tglpinjam, tglkembali) VALUES ('$id', '$namapinjam','$tglpinjam','$tglkembali')";
            $q1 = mysqli_query($koneksi, $sql1);
            if ($q1) {
...
<body>
    <nav aria-label="Breadcrumb">
        <ol class="flex items-center gap-1 text-sm text-gray-600">
            ...
            <li>
                <a href="pinjam3.php" class="block transition hover:text-gray-700"> List Buku </a>
            </li>
    ...
    <div class="mx-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php
                    header("refresh:5;url=pinjam3.php"); //5 detk 
                }
                ?>
                <?php
                if ($sukses) {
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" id="tglpinjam" name="tglpinjam" value="<?php echo date('Y-m-d'); ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" id="tglkembali" name="tglkembali" readonly>
                        </div>
                    </div>
                    ...
                    <script>
                        function hitungTanggalKembali() {
                            ...
                            if (!isNaN(tglPinjam)) {
                                ...
                                const tglKembali = tglPinjam.toISOString().split('T')[0];
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="pinjam3.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-warning">Pinjam</button></a>
                                </td>
                            </tr>
                        <?php
                        }
